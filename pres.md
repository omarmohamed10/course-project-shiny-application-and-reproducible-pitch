...
Overview
========================================================
This presentation contains documentation for the Diamond price prediction application. The application can be found [**here**] (https://omarmohamed10.shinyapps.io/Developing_Data_Products_Final_Project/)
...
Both files can be found here: [GitHub repo](https://github.com/omarmohamed10/course-project-shiny-application-and-reproducible-pitch)
